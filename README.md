...
![구성도](https://github.com/minjun7984/readme-image/blob/main/tickettalkarcht.png)
</br>
</br>
...
| 작업태그 | 내용 |
|------|------------------------------------------|
| **feat** | 새로운 기능 추가 / 일부 코드 추가 |
| **fix** | 버그 수정 |
| **refactor** | 코드 리팩토링 |
| **chore** | 빌드 혹은 패키지 매니저 수정 사항 |
| **rename** | 패키지, 폴더, 클래스명 수정 |
| **remove** | 패키지, 폴더, 클래스 삭제 |
| **style** | 코드 의미에 영향을 주지않는 변경사항 (코드 포맷팅, 오타, 변수명 변경) |
</br>
</br>
